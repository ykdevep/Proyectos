...
##                                                                                                                  ##
##                   Se leen los datos pertenecientes a los valores de contaminación de Ozono (03)                  ##
...
nombreBDOzono = 'bancosexternos'  ## Configuración para la base de dato de contaminantes NO...
config = {
  'user': 'kike',
  'password': 'kike123',
  'host': '127.0.0.1',
...
tablaOzono = {} ## Definición de la tabla de contaminantes NO...
tablaOzono[nombreBDOzono] = ( 
    "CREATE TABLE `ozono` ("
...
def create_database(cursor):  ## Función para la base de d...
    try:
        cursor.execute(
            "CREATE DATABASE {} DEFAULT CHARACTER SET 'utf8'".format(nombreBDOzono))
    except mysql.connector.Error as err:
        print ("   ")
...
for name, ddl in tablaOzono.items():
    try:
        print ("   ")
...
direccionFichero = "C:/Users/Cubano/Documents/GitHub/Proyectos/BancosDatos/O3.xls"
