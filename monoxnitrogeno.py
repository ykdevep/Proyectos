...
##                                                                                                                  ##
##            Se leen los datos pertenecientes a los valores de contaminación de Monóxido de Nitrógeno (NO)         ##
...
nombreBDMonoxNitr = 'bancosexternos'  ## Configuración para la base de dato de contaminantes NO...
config = {
  'user': 'kike',
  'password': 'kike123',
  'host': '127.0.0.1',
...
tablaMonoxNitr = {} ## Definición de la tabla de contaminantes NO...
tablaMonoxNitr[nombreBDMonoxNitr] = ( 
    "CREATE TABLE `monoxnitrogeno` ("
...
def create_database(cursor):  ## Función para la base de d...
    try:
        cursor.execute(
            "CREATE DATABASE {} DEFAULT CHARACTER SET 'utf8'".format(nombreBDMonoxNitr))
    except mysql.connector.Error as err:
        print ("   ")
...
try:  
    cnx.database = nombreBDMonoxNitr  
except mysql.connector.Error as err:
...
for name, ddl in tablaMonoxNitr.items():
    try:
        print ("   ")
...
direccionFichero = "C:/Users/Cubano/Documents/GitHub/Proyectos/BancosDatos/NO.xls"
...
addNO = ("INSERT INTO monoxnitrogeno"
