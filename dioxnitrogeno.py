...
##                                                                                                                  ##
##            Se leen los datos pertenecientes a los valores de contaminación de Dióxido de Nitrógeno (NO2)         ##
...
nombreBDDioxNitr = 'bancosexternos'  ## Configuración para la base de dato de contaminantes NO...
config = {
  'user': 'kike',
  'password': 'kike123',
  'host': '127.0.0.1',
...
tablaDioxNitr = {} ## Definición de la tabla de contaminantes NO...
tablaDioxNitr[nombreBDDioxNitr] = ( 
    "CREATE TABLE `dioxnitrogeno` ("
...
def create_database(cursor):  ## Función para la base de d...
    try:
        cursor.execute(
            "CREATE DATABASE {} DEFAULT CHARACTER SET 'utf8'".format(nombreBDDioxNitr))
    except mysql.connector.Error as err:
        print ("   ")
...
for name, ddl in tablaDioxNitr.items():
    try:
        print ("   ")
...
direccionFichero = "C:/Users/Cubano/Documents/GitHub/Proyectos/BancosDatos/NO2.xls"
...
addNO2 = ("INSERT INTO dioxnitrogeno"
...
for i in range(0, len(xls)):
    ...
    cursor.execute(addNO2, datosNO2)
    cnx.commit()
