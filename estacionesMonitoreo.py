######################################################################################################################
##                                                                                                                  ##
##   Módulo Python 3.6.5 (32 bits) para leer un fichero csv y guardar la información  en una base de datos MySQL    ##
##                                     mediante las librerías pandas y mysql                                        ##
##                                                                                                                  ##
##                   Se lee el csv perteneciente a las estaciones de monitoreo de contaminación                     ##
##      de la CDMX y el Estado de México con la finalidad de conocer el estado de las torres de muestreo de         ##
##                                  calidad del aire y nivel de contaminantes.                                      ##    
##                                                 1) IBI                                                           ##
##                                                 2) HRV                                                           ##
##                                                 3) EDA                                                           ##
##                                                 4) ACC                                                           ##
